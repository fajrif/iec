module PageHelper
	...
	def render_link_file_url(object, class_name="btn btn-medium btn-iec btn-rounded")
		_text = object.link_text
		_text = get_text_from_object(_text, object)
	...
	def get_iec_element_colors(bg_color)
	 if bg_color == 'bg-green' or bg_color == 'bg-black' or bg_color == "bg-dark-grey" or bg_color == "bg-green-gradient"
			...
			return 'text-extra-dark-gray', 'btn-iec'
		end
	end
	...
	def render_link_download_file(object, class_name="btn btn-medium btn-iec btn-rounded", text=t("global.download"))
