...
about_sumatra_kruh.title = "Kruh Block covers an area of 258 square kilo meters (63,753 acres) in Sumatra, Indonesia. This block produced an average of about 9,900 barrels of oil per month (gross) in 2018."
...
about_sumatra_kruh.title_tag = "h4"
Mobility.with_locale(:cn) {
	about_sumatra_kruh.title = "Kruh 区块位于印度尼西亚苏门答腊岛，占地 258 平方公里（63,753 英亩）。 2018 年，该区块平均每月生产约 9,900 桶石油（总量）。"
	about_sumatra_kruh.description = %q{
...
Section.create(page_id: @sumatra_kruh_page.id, snippet_id: sumatra_kruh_key_points.id, css_class: "p-0", order_no: 4)
