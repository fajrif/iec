...
Section.create(page_id: @sumatra_kruh_page.id, snippet_id: about_sumatra_kruh.id, css_class: "small-section", order_no: 1)
...
sumatra_kruh_video.template = "video_display"
sumatra_kruh_video.orientation = "right"
sumatra_kruh_video.video_url = ""
Mobility.with_locale(:cn) {
