...
about_desc.save
Section.create(page_id: @about_page.id, snippet_id: about_desc.id, css_class: "small-section", order_no: 1)
...
mission.save
Section.create(page_id: @about_page.id, snippet_id: mission.id, bg_color: "bg-black", css_class: "small-section", order_no: 2)
...
experience.template = "info_image"
...
# assign contact_us
Section.create(page_id: @about_page.id, snippet_id: @contact_us.id, bg_color: "bg-green-gradient", css_class: "half-section", order_no: 6)
