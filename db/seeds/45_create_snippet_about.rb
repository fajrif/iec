...
ownership_structure.image_id.attach(io: Rails.root.join("public/images/diagrams/Ownership-Structure-ID.png").open, filename: "Ownership-Structure-ID.png")
Mobility.with_locale(:id) {
...
organizational_structure.image_id.attach(io: Rails.root.join("public/images/diagrams/Organizational-Structure-ID.png").open, filename: "Organizational-Structure-ID.png")
Mobility.with_locale(:id) {
...
group_structure.image_id.attach(io: Rails.root.join("public/images/diagrams/Group-Structure-ID.png").open, filename: "Group-Structure-ID.png")
Mobility.with_locale(:id) {
