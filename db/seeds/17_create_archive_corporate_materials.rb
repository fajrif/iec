...
@nominating_charter.file.attach(io: Rails.root.join("public/reports/iec_archives/adopted-n-cg-committee-charter.pdf").open, filename: "adopted-n-cg-committee-charter.pdf")
...
@code_ethics_file.file.attach(io: Rails.root.join("public/reports/iec_archives/adopted-code-of-ethics.pdf").open, filename: "adopted-code-of-ethics.pdf")
Mobility.with_locale(:cn) {
...
@compensation_file.file.attach(io: Rails.root.join("public/reports/iec_archives/adopted-compensation-committee-charter.pdf").open, filename: "adopted-compensation-committee-charter.pdf")
Mobility.with_locale(:cn) {
...
@audit_file.file.attach(io: Rails.root.join("public/reports/iec_archives/adopted-audit-committee-charter.pdf").open, filename: "adopted-audit-committee-charter.pdf")
Mobility.with_locale(:cn) {
