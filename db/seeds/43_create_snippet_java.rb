...
Section.create(page_id: @java_citarum_page.id, snippet_id: about_java_citarum.id, css_class: "small-section", order_no: 1)
...
java_citarum_video.template = "video_display"
java_citarum_video.orientation = "right"
java_citarum_video.video_url = ""
Mobility.with_locale(:cn) {
